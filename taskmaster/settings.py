...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'tasks-app.herokuapp.com', 'tasks-app-4f0e62b80259.herokuapp.com']
...
# Use Heroku DATABASE_URL if available, otherwise use SQLite
if os.environ.get('DATABASE_URL') or DATABASE_URL:
    DATABASES = {
        'default': dj_database_url.config(
            default=os.environ.get('DATABASE_URL') or DATABASE_URL,
            conn_max_age=600,
